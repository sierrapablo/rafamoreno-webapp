...
import grupo2 from '../assets/DSC02044.jpg';
import grupo3 from '../assets/DSC02046.jpg';
import grupo4 from '../assets/DSC02086.jpg';
import grupo5 from '../assets/DSC02066.jpg';
...
export function ArtistGallery () {
    return (
        <section className="artistGallery">
            ...
            <img className="artistGallery-img" src={grupo5} alt="grupo5" />
        </section>
    )
}